...
class BasicAuthenticationActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        okGoUpdateHttpUtil.asyncGet("https://www.entrybank.xyz/gp?type=ng1",HashMap(),object : HttpManager.Callback{
        ...
        val purposeOptions = OptionsPickerBuilder(this,
            ...
            .setSubmitText(resources.getString(R.string.confirm)).setCancelText(resources.getString(
                R.string.cancel
            ))
                ...
                progressDialog.setListener(object : ProgressDialog.ProgressListener {
                    override fun onTimeOut() {
                        ...
                        SharedPreferencesUtils()
                            .saveData(this@BasicAuthenticationActivity, "basicStatus", true)
                        SharedPreferencesUtils()
                            .saveData(this@BasicAuthenticationActivity, "mailbox", et_meail.text.toString())
                        SharedPreferencesUtils()
                            .saveData(this@BasicAuthenticationActivity, "nin", et_aadhaar.text.toString())
                        SharedPreferencesUtils()
                            .saveData(this@BasicAuthenticationActivity, "name", et_firstName.text.toString()+et_lastName.text.toString())
                        startActivity(Intent(this@BasicAuthenticationActivity,
                            DanActivity::class.java))
                        finish()
                    }
                })
            }
